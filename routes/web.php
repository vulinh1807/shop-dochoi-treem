...
//Middleware
// Route::group(['prefix' => 'laravel-filemanager', 'middleware'] , 
//  function () {
...
//Backend
//Route::post('/admin','AuthController@login_auth');
Route::post('/admin',function(){
    return 'AuthController@login_auth';
});
Route::get('/admin','AdminController@login_auth');
...
Route::post('/register-auth','AuthController@register_auth');
//Route::post('/login-auth','AuthController@login_auth');
Route::post('/logout-auth','AuthController@logout_auth');
