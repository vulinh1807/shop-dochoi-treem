...
{{-- <link href="{{URL::URL::asset('/backend/css/jquery.dataTables.min.css')}}" rel="stylesheet"/> --}}
...
<link rel="stylesheet" href="{{URL::asset('/backend/css/bootstrap-tagsinput.css')}}" type="text/css"/>
...
<script src="https://canvasjs.com/URL::assets/script/jquery.canvasjs.min.js"></script>

 <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>

<script src="{{URL::asset('/backend/js/jquery.form-validator.min.js')}}"></script>
