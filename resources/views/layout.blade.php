...
<head>
    ...
    <link rel="icon" href="{{URL::asset('/frontend/images/logo-mail.png')}}" type="image/gif" sizes="32x32">
    ...
    <link href="{{URL::asset('/frontend/css/lightgallery.min.css')}}" rel="stylesheet">
    <link href="{{URL::asset('/frontend/css/lightslider.css')}}" rel="stylesheet">
    <link href="{{URL::asset('/frontend/css/prettify.css')}}" rel="stylesheet">
    <link href="{{URL::asset('/frontend/css/vlite.css')}}" rel="stylesheet">
    <link href="{{URL::asset('/frontend/css/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{URL::asset('/frontend/css/owl.theme.default.min.css')}}" rel="stylesheet">
...
<body>
                        ...
                        <div class="social-icons pull-right">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a target="_blank" title="{{$ico->name}}" href="{{$ico->link}}">
                                    <img alt="{{$ico->name}}" style="margin:4px" height="32px" width="32px" src="{{URL::asset('/uploads/icons/'.$ico->image)}}"></a>
                                </a></li>
                                @endforeach
              ...
              {{--   <div class="col-md-12">
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item" style="padding-left:0 !important; ">
                            <a target="_blank" href="{{$doitac->link}}"><p><img width="100%" src="{{URL::asset('/uploads/icons/'.$doitac->image)}}"></p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="companyinfo">
                            <p><img width="100%" src="{{URL::asset('/uploads/contact/logo54')}}"></p>
                        </div>
                    </div>
                    {{-- @endforeach --}}
    ...
    <script src="{{URL::asset('/frontend/js/lightgallery-all.min.js')}}"></script>
    <script src="{{URL::asset('/frontend/js/lightslider.js')}}"></script>
    <script src="{{URL::asset('/frontend/js/prettify.js')}}"></script>
    <script src="{{URL::asset('/frontend/js/vlite.js')}}"></script>
    <script src="{{URL::asset('/frontend/js/simple.money.format.js')}}"></script>
